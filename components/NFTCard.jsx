...
const NFTCard = ({ nft }) => {
  ...
  return (
    <Link href={{ pathname: '/nft-details', query: nft }}>
      <div className="flex-1 min-w-215 max-w-max xs:max-w-none sm:w-full sm:min-w-155 minmd:min-w-256 minlg:min-w-327 dark:bg-nft-black-3 bg-white rounded-2xl p-4 m-4 shadow-md cursor-pointer">
        ...
        <div className="mt-3 flex flex-col">
          ...
          <div className="flexBetween mt-1 minlg:mt-3 flex-row xs:flex-col xs:items-start xs:mt-3">
            ...
            <p className="font-poppins font-semibold text-xs minlg:text-lg dark:text-white text-nft-black-1 ">
              {nft.seller.length > 10 ? trimAddress(nft.seller) : nft.seller}
            </p>
          </div>
        </div>
      </div>
