...
const CreatorCard = ({ rank, creatorImage, creatorName, creatorEths }) => (
  ...
  <div className="min-w-190 minlg:min-w-240 dark:border-nft-black-1 dark:bg-nft-black-3 border border-nft-gray-2 rounded-3xl flex flex-col p-4 m-4 shadow-md">
    ...
    <div className="mt-3 minlg:mt-7 text-center textCenter fixed-col">
